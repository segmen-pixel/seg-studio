...
- **Anomaly detection (initial implementation)**: Auto-config, patch training, step progress display (superseded 2026-07 by the current z-score feature-bank detector)
