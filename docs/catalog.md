...
| Feature | What it does | Tag |
|---|---|:---:|
| Training modes | Standard / Quick / Transfer / Counting (Instance), selected before start | Core |
...
| Multi-arch | SimpleUNet / STDC | Core |
| Deep supervision | Auxiliary losses on intermediate layers | Core |
| 🆒 **Object counting** | Count parts per image; trains from the segmentation masks you already drew | Flagship |
| Tiled training & inference | Small objects stay at capture resolution instead of being resized away | Useful |
...
| Counting API | `/count` returns per-class counts and per-object boxes | Useful |
...
- 🚀 [First run walkthrough](first-run-manual.md) — Shortest single path to a first prediction
- 📘 [Beginner's handbook](handbook.md) — 16-chapter worked tutorial
- 📖 [Detailed user guide](user-guide.md) — Feature reference
- 🛠 [Troubleshooting](troubleshooting.md)
- 💻 [Developer quickstart](dev-quickstart.md)

---

_Seg-Studio Catalog — 0.9.8, 2026-07_
