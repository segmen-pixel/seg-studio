...
your first AI prediction — in about 10 minutes.
...
## Step 5: Train Your First Model (2-5 minutes)
...
5. Training stops automatically when the model stops improving. A short run on
   a few images typically finishes in 2-5 minutes.
...
- **Export your model** in ONNX or CoreML format for deployment on inspection
  devices.
