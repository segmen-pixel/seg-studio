...
footer: "Seg-Studio v1.0 — 2026-04"
style: |
  section {
...
<!-- Screenshot to be added (Marp bg): docs/assets/handbook/catalog_annotate.png -->
...
<!-- Screenshot to be added (Marp bg): docs/assets/handbook/catalog_augment.png -->
...
| Feature | What it does | Tag |
|---|---|:---:|
| Training modes | Standard / Quick / Transfer | <span class="badge std">Core</span> |
| Local GPU training | Train on the same PC | <span class="badge std">Core</span> |
| Transfer learning | Auto-select initial weights from past runs | <span class="badge good">Useful</span> |
...
| Multi-arch | SimpleUNet / STDC / DeepLabV3+ | <span class="badge std">Core</span> |

<!-- Screenshot to be added (Marp bg): docs/assets/handbook/catalog_training.png -->
...
<!-- Screenshot to be added (Marp bg): docs/assets/handbook/catalog_results.png -->
...
<!-- Screenshot to be added (Marp bg): docs/assets/handbook/catalog_export.png -->
...
<!-- Screenshot to be added (Marp bg): docs/assets/handbook/01_overview.png -->

**Full tour** — see 📘 `docs/handbook.md` (14 chapters, linear).
