...
Status: **Draft v1** (2026-07-22) — scope decisions locked with the product owner.
Japanese version: [docs/ja/design_instance_segmentation_v098.md](ja/design_instance_segmentation_v098.md)

Evidence base: a screw-counting proof of concept (2026-07-21/22) — RF-DETR-Seg Nano fine-tuned
