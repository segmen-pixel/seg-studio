...
def main():
    ...
    parser.add_argument("--arch", choices=["simpleunet", "stdc"],
    ...
    run_path = runs_root_of(base) / run_id
    ...
    config_dump = {
        ...
        "fg_ratio": fg_ratio,
        "tag": args.tag,
        # Naive UTC, as every train_config.json already on disk carries.
        # utcnow() is deprecated from 3.12; this is the same string.
