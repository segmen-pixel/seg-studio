...
| Module | Purpose |
| --- | --- |
| `segcore.training` | Models (`simpleunet`, `deeplabv3plus`, `stdc`), datasets, losses, the training loop, metrics (mIoU / F1 / calibration), sliding-window inference, and knowledge distillation |
...
print(__version__)           # e.g. "0.9.6"
print(list(MODEL_REGISTRY))  # ["simpleunet", "deeplabv3plus", "stdc"]
