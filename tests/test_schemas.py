...
class TestTrainRequest:
    def test_defaults(self):
        ...
        assert r.lr == 5e-4
        # rev. 2026-07-07 per-axis EDA (n=37): deeplabv3plus wins the
        # per-project best plurality (17/37); bc=128 wins 29/37;
        # fp=0.7 (0.5 is per-project best in only 1/37).
        assert r.arch == "deeplabv3plus"
