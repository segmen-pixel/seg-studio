...
class TrainRequest(BaseModel):
    ...
    arch: str = Field(default="deeplabv3plus")
    ohem_ratio: float = Field(default=0.0, ge=0.0, le=1.0)
    tversky_weight: float = Field(default=1.0, ge=0.0, le=5.0)
    tversky_alpha: float = Field(default=0.7, ge=0.0, le=1.0)
    tversky_beta: float = Field(default=0.3, ge=0.0, le=1.0)
    ...
    training_mode: str = Field(default="standard")  # standard | quick | transfer
