...
def evaluate_request_guard(
    *,
    ...
    # from SEG_HOST and the persisted lan_access flag, so it never sees
    ...
    # token: SEG_HOST and the lan_access flag both route through the startup
    ...
    if not local_peer:
        return "unauthorized", (
            ...
            "clients on the machine it runs on. Set SEG_API_TOKEN to allow "
