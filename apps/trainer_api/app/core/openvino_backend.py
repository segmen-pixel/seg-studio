...
def _iter_calibration_patches(run_path: Path, max_samples: int):
    ...
    # prepared/ lives at project_root, two levels up from run_path
    # (projects/<pid>/training/runs/<rid>/ → projects/<pid>/prepared)
    project_root = run_path.parent.parent.parent
