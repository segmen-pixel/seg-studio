...
# Re-exported from config so the backend has exactly one definition — this
# constant previously carried its own literal and drifted a release behind.
from .config import APP_VERSION  # noqa: F401 — re-exported for report templates
...
def generate_model_eval_report(
    ...
    # Score distribution
    preds_dir = predictions_dir(rdir)
