          ...
          <div className="section preview-frame">
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 8, flexWrap: "nowrap" }}>
                ...
                {projectId && s.activeRunId && (
                  <div className="results-preview-actions" style={{ display: "flex", gap: 6, marginLeft: "auto", alignItems: "flex-start" }}>
                    ...
                    <button className="ghost results-header-btn" onClick={() => setReportOpen(true)} disabled={!reportRun?.has_model} title={t("training.generateReport")} data-desc={t("training.generateReportDesc")}>
            ...
            >
              ...
              >
                ...
                <canvas ref={s.gtOutlineCanvasRef} style={{ opacity: s.showGtOutline ? 1 : 0, pointerEvents: "none" }} />
                {s.heatmapUrl && (
                  <img
                    src={s.heatmapUrl}
              ...
              {/* Region labels on overlay */}
              {s.showGtOutline && s.showRegionLabels && s.regionLabels.map((lbl, i) => {
