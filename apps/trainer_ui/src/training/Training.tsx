...
import TrainStartDialog from "./components/TrainStartDialog";
...
export default React.memo(function Training({
  ...
  const [trainingMode, setTrainingMode] = useState<"standard" | "quick" | "transfer" | "instance" | null>(null);
  ...
  return (
    <div className="training-layout">
      {startProgress && (
        <TrainStartDialog
          phase={startProgress.phase}
          detail={startProgress.detail}
          startedAt={startProgress.startedAt}
          onClose={dismissStartProgress}
        />
      )}
      <HyperparameterForm
        projectId={projectId}
