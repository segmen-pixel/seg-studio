...
type HyperparameterFormProps = {
  ...
  trainingMode?: "standard" | "quick" | "transfer" | "instance" | null;
  onTrainingModeChange?: (mode: "standard" | "quick" | "transfer" | "instance") => void;
};
    ...
    <div className="section training-config-section" style={{ marginBottom: 0 }}>
      ...
      <div className="training-start-row">
        ...
        <div className="training-left-controls">
          ...
          {/* Instance mode used to render its settings permanently expanded with
              no toggle, so the one mode with the most fields was the one you
              could not collapse. It now uses the same control as every other
              mode. */}
          <button
            ...
            aria-controls={trainingMode === "instance" ? "instance-panel" : "hyperparameter-panel"}
      ...
      {trainingMode === "instance" && form.hyperParamsOpen && (
        <InstanceSection projectId={projectId} form={form} showToast={showToast} />
      )}
      <div className="transfer-learning-fieldset">
        {form.hyperParamsOpen && trainingMode !== "instance" && (
